...
"""
Module for detecting player stack size from poker screenshots.
"""
...
class StackDetector:
    """Class for detecting player stack from poker screenshots."""
    
    def __init__(self, config=None, debug_mode=False):
        """Initialize the stack detector with optional configuration."""
        self.config = config or {}
        self.debug_mode = debug_mode
        logger.info("Stack detector initialized")
    
    def detect_player_stack(self, screenshot):
        """
        ...
        try:
            ...
            roi_y = int(h * 0.70)  # Start at 70% from the top
            roi_w = int(w * 0.06)  # Width is 6% of the screen width
            roi_h = int(h * 0.025)  # Height is 2.5% of the screen height
